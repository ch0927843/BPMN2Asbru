...
public class VariableKnownCondition extends ConditionBase {
	...
	public FilterPrecondition Convert()
	{
		if (comments.isEmpty())
		{
			return FilterPreconditionFactory.CreateFilterPrecondition(new IsKnownVariable(name), id);
		}
		else
		{
			...
			return FilterPreconditionFactory.CreateFilterPrecondition(new IsKnownVariable(name, asbruComments), id);
		}
	}
