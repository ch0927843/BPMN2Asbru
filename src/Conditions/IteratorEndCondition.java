...
public class IteratorEndCondition extends ConditionBase {
	...
	public FilterPrecondition Convert()
	{
		if (comments.isEmpty())
		{
			return FilterPreconditionFactory.CreateFilterPrecondition(new IsAtEnd(iterator), id);
		}
		else
		{
			...
			return FilterPreconditionFactory.CreateFilterPrecondition(new IsAtEnd(iterator, asbruComments), id);
		}
	}
